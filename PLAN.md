...
- 2026-09-10 leaf 1.2.1 verified 5/5 by driver (commit 283aef7: 77 files, −12,527 lines; zero payload refs, tsc clean). Deviations: sitemap page slugs via direct getDB() (contract-frozen content.ts exports), blog lastmod→publishedDate, Dockerfile/env/compose left for leaf 5. npm audit: 13 known vulns in dev-tooling transitive deps (2 low/4 mod/7 high) — surfaced, deferred to a dedicated dep pass.
